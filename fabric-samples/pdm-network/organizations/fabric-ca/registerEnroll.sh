...
function createHospital1() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@main.infili.com:7054 --caname ca-hospital1 --tls.certfiles ${PWD}/organizations/fabric-ca/hospital1/tls-cert.pem
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/main.infili.com-7054-ca-hospital1.pem
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@main.infili.com:7054 --caname ca-hospital1 -M ${PWD}/organizations/peerOrganizations/hospital1.com/peers/peer0.hospital1.com/msp --csr.hosts peer0.ohospital1.com --tls.certfiles ${PWD}/organizations/fabric-ca/hospital1/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@main.infili.com:7054 --caname ca-hospital1 -M ${PWD}/organizations/peerOrganizations/hospital1.com/peers/peer0.hospital1.com/tls --enrollment.profile tls --csr.hosts peer0.hospital1.com --csr.hosts main.infili.com --tls.certfiles ${PWD}/organizations/fabric-ca/hospital1/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@main.infili.com:7054 --caname ca-hospital1 -M ${PWD}/organizations/peerOrganizations/hospital1.com/users/User1@hospital1.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/hospital1/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://hospital1admin:hospital1adminpw@main.infili.com:7054 --caname ca-hospital1 -M ${PWD}/organizations/peerOrganizations/hospital1.com/users/Admin@hospital1.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/hospital1/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createHospital2() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin2:adminpw@main.infili.com:8054 --caname ca-hospital2 --tls.certfiles ${PWD}/organizations/fabric-ca/hospital2/tls-cert.pem
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/main.infili.com-8054-ca-hospital2.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/main.infili.com-8054-ca-hospital2.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generate the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@main.infili.com:8054 --caname ca-hospital2 -M ${PWD}/organizations/peerOrganizations/hospital2.com/peers/peer0.hospital2.com/msp --csr.hosts peer0.hospital2.com --tls.certfiles ${PWD}/organizations/fabric-ca/hospital2/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generate the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@main.infili.com:8054 --caname ca-hospital2 -M ${PWD}/organizations/peerOrganizations/hospital2.com/peers/peer0.hospital2.com/tls --enrollment.profile tls --csr.hosts peer0.hospital2.com --csr.hosts main.infili.com --tls.certfiles ${PWD}/organizations/fabric-ca/hospital2/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generate the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@main.infili.com:8054 --caname ca-hospital2 -M ${PWD}/organizations/peerOrganizations/hospital2.com/users/User1@hospital2.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/hospital2/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generate the org admin msp"
  set -x
  fabric-ca-client enroll -u https://hospital2admin2:hospital2adminpw@main.infili.com:8054 --caname ca-hospital2 -M ${PWD}/organizations/peerOrganizations/hospital2.com/users/Admin@hospital2.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/hospital2/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@main.infili.com:9054 --caname ca-orderer --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/main.infili.com-9054-ca-orderer.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/main.infili.com-9054-ca-orderer.pem
    OrganizationalUnitIdentifier: peer
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@main.infili.com:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp --csr.hosts orderer.example.com --csr.hosts main.infili.com --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@main.infili.com:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/tls --enrollment.profile tls --csr.hosts orderer.example.com --csr.hosts main.infili.com --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@main.infili.com:9054 --caname ca-orderer -M ${PWD}/organizations/ordererOrganizations/example.com/users/Admin@example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  { set +x; } 2>/dev/null
