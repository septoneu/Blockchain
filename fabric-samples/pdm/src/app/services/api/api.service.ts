...
export class ApiService {
  baseUrl = 'http://main.infili.com:5001/';
  ...
  getHospitalStatistics(hospitalId: number): Observable<any> {
    return this._http.get<any>(`http://main.infili.com:5000/hospital_stats/${hospitalId}`);
  }
  getHospitalHomomorphicData(): Observable<any> {
    return this._http.get<any>('http://main.infili.com:5007/encrypt_sums');
  }
